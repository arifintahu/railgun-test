// main.ts
import { startRailgunEngine, stopRailgunEngine } from "@railgun-community/wallet";
import { createNodeDatabase } from "../storage/database";
import { createArtifactStore } from "../storage/artifact-store";
